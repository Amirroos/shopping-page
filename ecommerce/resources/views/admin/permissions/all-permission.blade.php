...
<div class="card-body">
  ...
  @endif
    <div class="d-flex justify-content-between">
        ...
        <a class="nav-link btn btn-success btn-sm" href="create-permission">+ Create New Permission</a>    
    </div>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                <a href="edit-permission/{{$permission->id}}" class="btn btn-sm btn-info">Edit</a>
